...
valid item UUIDs remain authoritative. Migration 0031 adds order-independent
instance keys, carries forward the UUIDs generated by migration 0030, and keeps
the map intact when older web clients submit an equipment document without it.
