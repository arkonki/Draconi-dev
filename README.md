...
`resolve_solo_check`, `push_solo_check`, `resolve_solo_check_consequence`,
`add_solo_waypoints`, `begin_solo_return`, `set_solo_threat`,
`resolve_solo_threat`, `select_solo_mission_marks`,
`resolve_solo_advancement`, `claim_solo_advancement_ability`, `search_waypoint`,
