...
export const GM_WORKFLOW_VERSION = 'draconi-gm-v1';
...
export const gmWorkflowGuide = {
  ...
  authority: [
    ...
    'Read current state before narrating or changing an existing campaign. Never reconstruct state from conversation memory.',
  ...
  workflows: {
    sessionStart: [
      ...
      'Call get_campaign_state. For Solo Mode, also call get_solo_state before narrating.',
    ...
    sessionCompletion: [
      'Read get_campaign_state and, when useful, get_recent_events before composing the record.',
  ...
  recovery: {
    revisionConflict: [
      'On REVISION_CONFLICT, call get_campaign_state again, reassess the intended action against the new state, and do not blindly replay stale arguments.',
    ...
    interruptedConversation: [
      'Do not rely on remembered tool results. Read get_campaign_state and get_recent_events, then continue from the returned active session and combat state.',
    ...
    missingIdentifiers: [
      'Use list_campaigns, get_campaign_state, get_encounter_setup_options, or get_combat_state to rediscover identifiers. Never guess them.',
    ],
    reconnect: [
      ...
      messages: [{
        ...
        content: {
          ...
          text: [
            ...
            campaignId
              ? `The campaign ID is ${campaignId}. Call get_campaign_state before narrating or acting.`
              : 'No campaign ID was supplied. Call list_campaigns and never guess an identifier.',
            playMode === 'solo'
              ? 'After get_campaign_state, call get_solo_state before narrating or acting.'
      ...
      messages: [{
        ...
        content: {
          ...
          text: [
            ...
            campaignId
              ? `Call get_campaign_state for ${campaignId}, then get_recent_events. If combat is active, also call get_combat_state.`
      ...
      messages: [{
        ...
        content: {
          ...
          text: [
            ...
            campaignId
              ? `Call get_campaign_state for ${campaignId} and get_recent_events before preparing the record.`
